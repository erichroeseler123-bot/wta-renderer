...
export default function AboutPage() {
  const aboutFaqs: FAQItem[] = [
    {
      question: "How does Welcome To Alaska Tours choose which tours to show?",
      answer:
        "We prioritize cruise-day-friendly options with clear timing and live availability checks.",
    },
    {
      question: "Is booking secure?",
      answer:
        "Yes. Payments are processed through Stripe with encrypted checkout and confirmation tracking.",
    },
    {
      question: "Can your team help us choose tours for our ship date?",
      answer:
        "Yes. Contact support with ship, date, and group details and we can guide you toward the best-fit options.",
    },
  ];
