...
export default function HomepageForm({
  ...
  return (
    <>
      <style>{`
        main nav a[href="/ships"],
        main a[href="/ships"].group {
          display: none !important;
        }

        main > section:has(a[href="/ships"].inline-flex) {
          display: none !important;
        }

        main section:has(a[href="/ships"].group) > div > div:first-child > p {
          display: none !important;
        }

        main section:has(a[href="/ships"].group) div[class*="lg:grid-cols-3"] {
          grid-template-columns: repeat(2, minmax(0, 1fr)) !important;
        }

        main > section:has(a[href="/ships"].inline-flex) + section details:nth-child(3) {
          display: none !important;
        }
      `}</style>
