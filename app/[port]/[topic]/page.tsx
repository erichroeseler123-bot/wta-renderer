...
const PAGES: PageConfig[] = [
  ...
  { port: "juneau", topic: "glacier-tours", title: "Juneau Glacier Tours: Mendenhall, Icefields & Treks", h1: "Juneau glacier tours and icefield adventures", description: "Compare Juneau glacier excursions from scenic Mendenhall viewing to lake canoe paddles, helicopter landings and guided ice treks.", intro: "Juneau is the glacier capital of Southeast Alaska cruise itineraries. Compare four distinct ways to experience glaciers: scenic visitor-center viewing, lake kayaking and canoeing, helicopter ice landings, and guided crampon ice treks on the Juneau Icefield.", chooserTopic: "glaciers", keywords: ["glacier", "icefield", "trek", "mendenhall", "norris", "taku", "herbert"], eyebrow: "Signature Juneau Glacier Experiences", decisionTitle: "View from shore, paddle the lake, or fly to the ice?", decisionIntro: "Glacier days vary dramatically in physical intensity and price. Match your activity level and timing with your ship's port schedule.", decisionPoints: [
    ...
    { title: "Helicopter ice landings & treks", text: "Fly deep onto the icefield to step onto ancient blue ice with professional glacier guides." },
  ], faqs: [
  ...
  ], related: [{ href: "/juneau/mendenhall-glacier-tours", label: "Mendenhall Glacier tours" }, { href: "/juneau/helicopter-tours", label: "Helicopter glacier flights" }, { href: "/guides/how-to-get-to-mendenhall-glacier-from-cruise-port", label: "Getting to Mendenhall guide" }] },
  { port: "juneau", topic: "easy-shore-excursions", title: "Easy Juneau Shore Excursions: Accessible & Low-Walking Tours", h1: "Easy Juneau shore excursions for cruise passengers", description: "Compare relaxing, low-walking Juneau excursions: covered whale watching catamarans, scenic Mendenhall drives, tramway, and salmon bakes.", intro: "Not every Alaska cruise day needs to be an extreme wilderness trek. If you are traveling with seniors, young kids, or prefer a relaxed pace, these connected Juneau excursions feature enclosed heated seating, minimal walking, and step-free or low-step transportation.", chooserTopic: "best-overall", keywords: ["salmon bake", "tramway", "sightseeing", "scenic", "city tour", "whale", "mendenhall"], eyebrow: "Comfortable, Low-Stress Cruise Days", decisionTitle: "Comfortable sightseeing with zero stress", decisionIntro: "Enjoy Southeast Alaska's greatest sights without steep hikes or rugged terrain.", decisionPoints: [
  ...
  ], related: [{ href: "/ports/juneau", label: "All Juneau excursions" }, { href: "/guides/easy-alaska-shore-excursions", label: "Alaska easy tours guide" }, { href: "/juneau/whale-watching", label: "Juneau whale watching" }] },
  { port: "juneau", topic: "private-tours", title: "Private Juneau Shore Excursions: Whale & Charter Boats", h1: "Private Juneau shore excursions and custom charters", description: "Book private Juneau excursions for your family or group: private whale watching boats, custom fishing charters, and private vans.", intro: "Experience Juneau on your own terms with a private boat or vehicle charter. Perfect for families, private parties, or photographers seeking undivided attention, customizable itineraries, and dedicated on-time ship return.", chooserTopic: "private-premium", keywords: ["private", "charter", "exclusive", "custom"], eyebrow: "VIP & Private Group Charters", decisionTitle: "Why choose a private Juneau excursion?", decisionIntro: "Private charters eliminate tour bus crowds and adapt the day entirely to your family's pace.", decisionPoints: [
  ...
  ], related: [{ href: "/juneau/whale-watching", label: "Juneau whale watching" }, { href: "/juneau/fishing", label: "Juneau fishing charters" }, { href: "/guides/private-premium-alaska-shore-excursions", label: "Private Alaska tours guide" }] },
  ...
  { port: "ketchikan", topic: "wildlife-tours", title: "Ketchikan Wildlife & Eagle Tours for Cruise Passengers", h1: "Ketchikan wildlife tours and eagle viewing", description: "Explore Ketchikan wildlife excursions: coastal bald eagle viewing, marine mammal safaris, rainforest sanctuaries, and salmon streams.", intro: "Known as the Gateway to Alaska, Ketchikan's pristine coastal rainforest hosts North America's highest concentration of bald eagles, alongside black bears, harbor seals, and humpback whales. Compare connected wildlife excursions with live cruise-day departure schedules.", chooserTopic: "wildlife-whales", keywords: ["wildlife", "eagle", "sanctuary", "rainforest", "seal", "marine", "bear"], eyebrow: "Rich Coastal Rainforest Wildlife", decisionTitle: "Choose your Ketchikan wildlife habitat", decisionIntro: "View wildlife from open zodiacs on coastal waters or from elevated walkways in old-growth rainforest.", decisionPoints: [
    { title: "Rainforest sanctuary & raptors", text: "Walk elevated boardwalks through mossy old-growth forests with an active raptor center." },
  ...
  ], related: [{ href: "/ketchikan/bear-tours", label: "Ketchikan bear tours" }, { href: "/ketchikan/misty-fjords", label: "Misty Fjords excursions" }, { href: "/ports/ketchikan", label: "Ketchikan cruise port guide" }] },
  { port: "ketchikan", topic: "easy-shore-excursions", title: "Easy Ketchikan Shore Excursions: Duck Tours, Trolley & Culture", h1: "Easy Ketchikan shore excursions for cruise passengers", description: "Compare relaxed, low-walking Ketchikan tours: Ketchikan Duck amphibious tours, historic town trolleys, totem parks, and covered cruises.", intro: "Ketchikan's historic downtown is famously walkable, and these low-impact excursions provide fantastic sightseeing with minimal physical exertion. Perfect for seniors, families with young children, or travelers who want a relaxed Alaska port day.", chooserTopic: "best-overall", keywords: ["duck", "trolley", "totem", "saxman", "historic", "creek street", "town"], eyebrow: "Low-Walking & Family Friendly", decisionTitle: "See Ketchikan with zero physical strain", decisionIntro: "Explore native totem poles, historic Creek Street, and harbor wildlife from comfortable seating.", decisionPoints: [
  ...
  ], related: [{ href: "/ports/ketchikan", label: "All Ketchikan excursions" }, { href: "/guides/first-time-in-ketchikan-shore-excursions", label: "First time in Ketchikan guide" }, { href: "/ketchikan/misty-fjords", label: "Misty Fjords tours" }] },
  { port: "ketchikan", topic: "private-tours", title: "Private Ketchikan Shore Excursions: Hummer, Boat & Flight Charters", h1: "Private Ketchikan shore excursions and luxury charters", description: "Book private Ketchikan shore excursions: luxury Hummer rainforest tours, private wildlife boats, and exclusive Misty Fjords floatplanes.", intro: "Experience Ketchikan privately with your family or traveling group. Enjoy dedicated pickup directly from your berth, customizable stops at totem parks, waterfalls, and scenic viewpoints, and personalized back-to-ship coordination.", chooserTopic: "private-premium", keywords: ["hummer", "private", "charter", "exclusive", "custom"], eyebrow: "Exclusive Group & Private Charters", decisionTitle: "Tailor Ketchikan to your group", decisionIntro: "Private transport offers unmatched flexibility for photography, multi-generational families, and relaxed exploring.", decisionPoints: [
  ...
  ], related: [{ href: "/ketchikan/misty-fjords", label: "Misty Fjords flightseeing" }, { href: "/ports/ketchikan", label: "Ketchikan port guide" }, { href: "/guides/private-premium-alaska-shore-excursions", label: "Private Alaska tours guide" }] },
  ...
  { port: "skagway", topic: "easy-shore-excursions", title: "Easy Skagway Shore Excursions: Historic Town & Liarsville Camp", h1: "Easy Skagway shore excursions for cruise passengers", description: "Compare easy, low-walking Skagway excursions: Liarsville Gold Rush camp, historic town tours, salmon bakes, and scenic overlooks.", intro: "Skagway is nestled in a flat valley surrounded by towering peaks, making it exceptionally visitor-friendly. If you prefer low-impact sightseeing, compare these accessible excursions featuring seated gold panning, live melodrama, and comfortable coach travel to scenic White Pass lookouts.", chooserTopic: "best-overall", keywords: ["liarsville", "camp", "gold", "historic", "scenic", "town"], eyebrow: "Accessible Gold Rush History", decisionTitle: "Experience the Klondike Gold Rush comfortably", decisionIntro: "Discover authentic 1898 history without demanding hikes or long trail marches.", decisionPoints: [
  ...
  ], related: [{ href: "/ports/skagway", label: "Skagway port guide" }, { href: "/guides/best-things-to-do-in-skagway-4-6-hours", label: "Skagway in 4-6 hours guide" }, { href: "/skagway/gold-rush-tours", label: "Skagway Gold Rush tours" }] },
  { port: "skagway", topic: "private-tours", title: "Private Skagway Shore Excursions: Custom Vans & Scenic Charters", h1: "Private Skagway shore excursions and custom tours", description: "Book private Skagway shore excursions: private passenger vans to the Yukon border, custom gold rush history, and exclusive departures.", intro: "Discover the breathtaking Klondike Highway and historic Skagway in the comfort of a private passenger vehicle. Enjoy dedicated pickup at your ship gangway, flexible photo stops at waterfalls and alpine lakes, and personalized travel to the Yukon border.", chooserTopic: "private-premium", keywords: ["private", "charter", "custom", "van"], eyebrow: "Personalized Klondike Exploration", decisionTitle: "Travel beyond the bus crowds", decisionIntro: "A private vehicle allows your party to dictate stops, explore pristine mountain passes, and travel at your own pace.", decisionPoints: [
  ...
  ], related: [{ href: "/ports/skagway", label: "All Skagway excursions" }, { href: "/skagway/helicopter-tours", label: "Skagway helicopter flights" }, { href: "/guides/private-premium-alaska-shore-excursions", label: "Private Alaska tours guide" }] },
];
